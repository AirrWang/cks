...
public class SignCalendar extends ViewFlipper  {
  ...
  public static final int COLOR_TX_WEEK_TITLE = Color.parseColor("#dcdcdc"); // 星期标题文字颜色
  public static final int BEFORE_TODAY_BACKGROUND = Color.parseColor("#333333"); // 星期标题文字颜色
...
//TODO
   ...
   **********************************************/
  //设置标记
  private void setMarker(RelativeLayout group, int i, int j, TextView view) {
    ...
    if (marksMap.get(dates[i][j]) != null) {
      if (childCount < 2) {
        ...
        //TODO
        params.height= (int) (ScreenUtils.getScreenWidth()/18);
        params.width=(int) (ScreenUtils.getScreenWidth()/18);
        markView.setLayoutParams(params);
        markView.setBackgroundResource(R.drawable.text_rdio_dk);//打卡成功标记
