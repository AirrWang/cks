 ...
 */
public class MineRecordCalFragment extends android.support.v4.app.Fragment  {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_mine_record_cal, container, false);
        initId();
        initWeekData();
        initMonthData();
        initYearData();
...
//                ToastUtils.showShort(getActivity(), "网络状况异常，请检查");
    ...
    private void initId() {
        ll_wRecord = (LinearLayout) view.findViewById(R.id.ll_mine_weekrecord);
        ll_wRecordTime = (LinearLayout) view.findViewById(R.id.ll_mine_weekrecordtime);
        ll_mRecord = (LinearLayout) view.findViewById(R.id.ll_mine_monthrecord);
        ll_mRecordTime = (LinearLayout) view.findViewById(R.id.ll_mine_monthrecordtime);
        ll_yRecord = (LinearLayout) view.findViewById(R.id.ll_mine_yearrecord);
        ll_yRecordTime = (LinearLayout) view.findViewById(R.id.ll_mine_yearrecordtime);
