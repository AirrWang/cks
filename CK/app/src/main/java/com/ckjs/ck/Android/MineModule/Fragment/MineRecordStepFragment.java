...
public class MineRecordStepFragment extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_mine_record_step, container, false);
...
//    }
    ...
    private void initId() {
        ll_wRecord = (LinearLayout) view.findViewById(R.id.ll_mine_weekrecordstep);
        ll_wRecordTime = (LinearLayout) view.findViewById(R.id.ll_mine_weekrecordsteptime);
        ll_mRecord = (LinearLayout) view.findViewById(R.id.ll_mine_monthrecordstep);
        ll_mRecordTime = (LinearLayout) view.findViewById(R.id.ll_mine_monthrecordsteptime);
        ll_yRecord = (LinearLayout) view.findViewById(R.id.ll_mine_yearrecordstep);
        ll_yRecordTime = (LinearLayout) view.findViewById(R.id.ll_mine_yearrecordsteptime);
