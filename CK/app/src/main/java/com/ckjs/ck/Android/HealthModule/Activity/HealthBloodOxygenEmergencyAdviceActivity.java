...
public class HealthBloodOxygenEmergencyAdviceActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        int user_id = (int) (SPUtils.get(HealthBloodOxygenEmergencyAdviceActivity.this, "user_id", 0));
        String token = (String) SPUtils.get(HealthBloodOxygenEmergencyAdviceActivity.this, "token", "");
        Call<OxyWarningBean> callBack = restApi.oxywarning(user_id+"",token,id);

        callBack.enqueue(new Callback<OxyWarningBean>() {
            @Override
            public void onResponse(Call<OxyWarningBean> call, Response<OxyWarningBean> response) {
                ...
                if (response.body() != null) {
                    if (response.body().getStatus().equals("1")) {
                        ...
                        ToastUtils.showShort(HealthBloodOxygenEmergencyAdviceActivity.this,response.body().getMsg());
                    }
                }
            ...
            @Override
            public void onFailure(Call<OxyWarningBean> call, Throwable t) {
                MoudleUtils.toChekWifi(HealthBloodOxygenEmergencyAdviceActivity.this);
                MoudleUtils.kyloadingDismiss(builder);
            }
        });
    }
     ...
     * @param info
     */
    private void initUI(OxyWarningBean.OxyWarningInfoBean info) {
        tv_advice_data.setText(info.getDay()+" "+info.getApm()+info.getTime());
        tv_advice_2.setText(info.getOxygen()+"%");
    ...
    private void initId() {
        ...
        ll_health_advice.setBackgroundResource(R.drawable.ll_rectangle_circl_bloodoxygen);
    }
