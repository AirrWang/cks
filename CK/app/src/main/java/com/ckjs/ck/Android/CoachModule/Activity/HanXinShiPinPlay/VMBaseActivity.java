...
public class VMBaseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LogUtils.i("%s onCreate:" + className);
        activity = this;
    ...
    protected void onRestart() {
        super.onRestart();
        LogUtils.i("%s onRestart:" + className);
    }

    @Override
    protected void onStart() {
        super.onStart();
        LogUtils.i("%s onStart:" + className);
    }

    @Override
    protected void onResume() {
        super.onResume();
        LogUtils.i("%s onResume:" + className);
    }

    @Override
    protected void onPause() {
        super.onPause();
        LogUtils.i("%s onPause:" + className);
    }

    @Override
    protected void onStop() {
        super.onStop();
        LogUtils.i("%s onStop:" + className);
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        LogUtils.i("%s onDestroy:" + className);
        activity = null;
    }
