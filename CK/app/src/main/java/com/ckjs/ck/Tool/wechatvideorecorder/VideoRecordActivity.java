package com.ckjs.ck.Tool.WechatVideoRecorder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recoderView.setRecorderListener(new VideoRecorderView.RecorderListener() {
            ...
            public void recordSuccess(File videoFile) {
                ...
                NotifyActivityToSmallPlayManager.getInstance().sendMessageActivityToSmallPlay(true,videoFile.getAbsolutePath());
                finish();
                releaseAnimations();
            }
