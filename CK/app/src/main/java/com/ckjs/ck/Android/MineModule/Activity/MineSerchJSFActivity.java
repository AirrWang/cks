...
public class MineSerchJSFActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.mine_search_back:
                KeyBoardUtils.closeKeyboard(et_search, MineSerchJSFActivity.this);
                finish();
                break;
    ...
    private void toSearch(String s) {
        ...
        Call<CitySearchBean> callBack = restApi.citygymsearch(citysele, s, 0 + "");
        ...
        callBack.enqueue(new Callback<CitySearchBean>() {
            ...
            public void onResponse(Call<CitySearchBean> call, Response<CitySearchBean> response) {
                if (response.body() != null) {
                    ...
                    if (response.body().getStatus().equals("1")) {
                        ...
                        ToastUtils.show(MineSerchJSFActivity.this, response.body().getMsg(), 0);
                    } else if (response.body().getStatus().equals("2")) {
                        ToastUtils.showShort(MineSerchJSFActivity.this, response.body().getMsg());
                    }
                }
            ...
            public void onFailure(Call<CitySearchBean> call, Throwable t) {
                MoudleUtils.toChekWifi(MineSerchJSFActivity.this);
                MoudleUtils.kyloadingDismiss(builder);
            }
        });
    ...
    private void initSet() {
        mine_search_jsf.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.putExtra("gym_id", body.getInfo().get(position).getGym_id());
                intent.setClass(MineSerchJSFActivity.this, MineBindJSFActivity.class);
