...
public class MineRecordWeightFragment extends android.support.v4.app.Fragment {
    ...
    public MineRecordWeightFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_mine_record_weight, container, false);
        initId();
        initWeekData();
        initMonthData();
        initYearData();
...
//    }
    ...
    private void initId() {
        ll_wRecord = (LinearLayout) view.findViewById(R.id.ll_mine_weekrecordweight);
        ll_wRecordTime = (LinearLayout) view.findViewById(R.id.ll_mine_weekrecordweighttime);
        ll_mRecord = (LinearLayout) view.findViewById(R.id.ll_mine_monthrecordweight);
        ll_mRecordTime = (LinearLayout) view.findViewById(R.id.ll_mine_monthrecordweighttime);
        ll_yRecord = (LinearLayout) view.findViewById(R.id.ll_mine_yearrecordweight);
        ll_yRecordTime = (LinearLayout) view.findViewById(R.id.ll_mine_yearrecordweighttime);
