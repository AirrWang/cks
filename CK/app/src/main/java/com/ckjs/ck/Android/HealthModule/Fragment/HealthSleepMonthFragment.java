 ...
 */
public class HealthSleepMonthFragment extends Fragment {
    ...
    private MSleepInfoBean.MSleepDetailInfoBean answer;
    ...
    public HealthSleepMonthFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_health_sleep_month, container, false);
    ...
    private void initData() {
        ...
        Call<MSleepInfoBean> callBack = restApi.msleepinfo(user_id + "", token);

        callBack.enqueue(new Callback<MSleepInfoBean>() {
            @Override
            public void onResponse(Call<MSleepInfoBean> call, Response<MSleepInfoBean> response) {
            ...
            @Override
            public void onFailure(Call<MSleepInfoBean> call, Throwable t) {
    ...
    private void initFailUI() {
        ...
        tv_month.setText(answer.getMonth());
    }
