 ...
 */
public class ListAdapterYuYued extends BaseAdapter {
    ...
    public List<BodyanalysedBean.BodyanalysedBeanInfo.Date> getList() {
        return list;
    }


    private List<BodyanalysedBean.BodyanalysedBeanInfo.Date> list;
    private Context context;

    public ListAdapterYuYued(Context context) {
        super();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            view = LayoutInflater.from(context).inflate(
                    R.layout.item_list_yu_yued, null);
    ...
    private void initData(MyHolder myHolder, int position) {
        ...
        MoudleUtils.textViewSetText(myHolder.tv_distance, "距离："+list.get(position).getDistance());
    }
    ...
    public void setList(List<BodyanalysedBean.BodyanalysedBeanInfo.Date> list) {
        this.list = list;
    }
