...
import com.ckjs.ck.Tool.Location.route.Adapter.BusSegmentListAdapter;
import com.ckjs.ck.Tool.Location.route.overlay.BusRouteOverlay;
...
public class BusRouteDetailActivity extends Activity implements OnMapLoadedListener,
	...
	private void init() {
		...
		MoudleUtils.viewShow(mDesBusRoute);

		mBusMap = (LinearLayout)findViewById(R.id.title_map);
		MoudleUtils.viewShow(mBusMap);
	...
	public void onMapClick(View view) {
		...
		MoudleUtils.viewGone(mBuspathview);
		MoudleUtils.viewGone(mBusMap);
		MoudleUtils.viewShow(mapView);
